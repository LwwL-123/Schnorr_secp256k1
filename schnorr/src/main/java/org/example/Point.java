...
public class Point {
    ...
    final static private BigInteger TWO = BigInteger.ONE.add(BigInteger.ONE);
    ...
    public static String genPubKey(byte[] secKey){
        ...
        return Util.bytesToHex(bytesFromPoint(ret));
    }
